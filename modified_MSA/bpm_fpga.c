...
{       
        ...
        start = clock();
        printf("Start bpm FPGA function\n\r");
        printf("N: %d, M: %d\n\r",n,m);
        ...
        *((volatile uint32_t *)(mapped_base + OFFSET_REG4)) = 0;
        ...
        {   
                ...
                printf("t[%d] = %d\n\r", i, p[i]);
                *((volatile uint32_t *)(mapped_base + OFFSET_REG1)) = p[i];
...
{       
        //printf("Start bpm_block function\n\r");
        //printf("LEN: %d\n\r", n);
        int32_t w;
        int32_t w_bytes;
        int32_t b_max;
